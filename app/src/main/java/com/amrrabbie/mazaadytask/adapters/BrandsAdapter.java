...
public class BrandsAdapter extends BaseAdapter {
    ...
    public BrandsAdapter(Context context, List<OptionsItem> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        BrandsAdapter.SpinnerViewHolder holder=null;
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.spinner_row, viewGroup, false);
            holder=new BrandsAdapter.SpinnerViewHolder(view);
            view.setTag(holder);
        }else{
            holder= (BrandsAdapter.SpinnerViewHolder) view.getTag();
        }
